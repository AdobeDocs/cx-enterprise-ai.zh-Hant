...
| 使用案例 | 說明 | 技能 | 應用程式 | 範例提示 |
|---|---|---|---|---|
| 建置計畫 | 將現有方案範本調整至新方案，從純語言行銷活動說明或上傳的行銷活動簡訊產生Smart Campaigns、排程和預留位置電子郵件。 | `build-programs` | Adobe Marketo Engage | 「為我們8月產品示範建立網路研討會註冊計畫」<br><br>「建立當潛在客戶點選50分時觸發的計畫」<br><br>「為未作用中的90天潛在客戶建立3封電子郵件的重新參與系列」 |
