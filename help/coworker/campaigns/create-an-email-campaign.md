---
description: 在Adobe同事行銷活動中產生電子郵件行銷活動的逐步指南，從撰寫提示到檢閱和匯出行銷活動。
title: 建立電子郵件行銷活動
...
* 有效的Adobe同事行銷活動帳戶([在此註冊](https://coworker-campaigns.experience.adobe.com/){target="_blank"} （如果尚未註冊）。
...
>[!TIP]
>
>在「行銷活動同事」編輯器或對話方塊（行銷活動、歷程等）中，隨時按ESC鍵 以快速結束。
