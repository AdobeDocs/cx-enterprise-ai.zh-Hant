---
title: 存取CX Coworker閘道工具
description: 使用Adobe CX Coworker Gateway工具之前，請確認產品可用性、組織啟用和許可權。
hide: true
...
| Journey Optimizer | Beta | 有效的Journey Optimizer授權、Adobe組織的Beta啟用，以及檢視行銷活動、歷程和管道設定的許可權。 |
...
| 目標 | Beta | 具有Adobe Experience Platform組織的有效Target授權。 請參閱[目標MCP檔案](https://experienceleague.adobe.com/zh-hant/docs/target/using/mcp/target-mcp-get-started)。 |
...
如需Beta或有限版本的產品工具，請聯絡您的Adobe客戶代表，並指定要使用的CX Coworker Gateway產品工具的Adobe 。 您的代表可協調產品啟用，並在您的Adobe組織準備好時確認。
...
下一步： [安裝Adobe CX Coworker閘道](install.md)。