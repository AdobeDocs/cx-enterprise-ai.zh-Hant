...
| 用於內容產生的AI助理（Adobe Journey Optimizer / Adobe Campaign中的功能） | [文件](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/content-management/generate-content/generative-c2pa-metadata) |
