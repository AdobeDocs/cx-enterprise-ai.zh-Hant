---
title: Adobe Experience Platform Agents試用版
...
# Adobe Experience Platform Agents試用版

>[!AVAILABILITY]
>
>某些符合資格的Experience Cloud客戶在承諾授權之前，可能會存取Adobe Experience Platform代理程式試用版，以便在他們自己的環境中體驗代理程式的價值。

以下影片旨在協助您瞭解Adobe Experience Platform Agents試用版。
...
>[!IMPORTANT]
>
>AI點數僅存在於試用期間，如果您在使用完整的10,000個AI點數權益之前授權其他AI點數，則&#x200B;**不會滾動**。

一旦您沖銷10,000個AI積分或授權其他AI積分的初始一次性權益，試用期即結束。 雖然您不會立即失去存取權或需支付使用過量的費用，但這些權益的延長由Adobe自行決定。 您必須在試用完成後立即授權其他AI積分，才能繼續使用Experience Platform代理程式而不會造成中斷。 如需如何授權其他AI積分，請聯絡您的Adobe客戶團隊。

## 存取及開始使用由Agent Orchestrator提供支援的AI助理

合格客戶的使用者可在此試用版中存取AI Assistant和代理程式，因此不需要採取任何動作。 Experience Platform代理程式會接受使用者輸入和監督的指引。 代理程式也會遵循先前定義的產品層級存取控制，因此使用者只能在適用的Experience Cloud產品內，對其擁有許可權的執行工作或執行動作。 如果您想要選擇退出存取這些代理功能並停用試用版存取，請傳送要求給[aep-agents-trial-support@adobe.com](mailto:aep-agents-trial-support@adobe.com)。
...
>[!TIP]
>
>取得協助 — 請傳送要求給[aep-agents-trial-support@adobe.com](mailto:aep-agents-trial-support@adobe.com)。
...
Adobe Experience Platform Agents試用版可讓符合資格的客戶使用特定代理，不需額外付費，最多可使用10,000個AI信用額度。 目標是在客戶做出商業決定之前，提供低摩擦、低風險的途徑，讓客戶從這些代理獲得體驗價值。
...
試用版不需要額外購買。 付費方案沒有自動轉換。 如果您決定在試用期之後繼續使用代理程式，您的Adobe帳戶團隊將與您合作，轉換至付費優惠方案。
...
請閱讀下列指南，以取得有關Agent Orchestrator和AI Assistant的詳細資訊：
