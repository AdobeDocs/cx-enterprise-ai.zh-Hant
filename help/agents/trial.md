...
>[!AVAILABILITY]
>
>某些符合資格的CX Enterprise客戶在承諾購買前，可以先使用相關使用規範試用版，體驗Adobe代理AI產品在自己環境中的價值。

根據Adobe的判斷，試用中的客戶將可存取&#x200B;**同事聊天**，這是AI助理對話體驗的演化。 Co-worker Chat可讓團隊透過自然語言自動化CXO產品工作，透過彈性規劃、可自訂的技能和智慧型執行快速將想法轉化為行動。
...
客戶是否資格使用試用版完全由Adobe自行決定。 已擁有Experience Platform Agents AI信用額度或具有其授權的客戶無法使用此試用版。
...
>[!IMPORTANT]
>
>- 當客戶耗用其最初的10,000個AI點數一次性配額，或單獨購買其他AI點數的授權時（以先到者為準），試用即結束。 AI點數僅存在於試用體驗期間，如果客戶在使用完整的10,000個AI點數試用配額之前購買額外的AI點數，則不會延期。  雖然客戶可能不會立即失去存取權或收取使用過量的費用，但這些權益的延長由Adobe自行決定，客戶必須在試用完成後立即購買額外的AI積分，才能繼續使用Co-worker Chat （或Adobe Experience Platform代理程式），不會造成中斷。
>
>- Adobe保留在任何時間及因任何理由暫停或終止客戶對同事聊天（或Adobe Experience Platform代理程式）的存取權。 Adobe可隨時自行決定撤銷或以其他方式變更本試驗。

## 存取指南

### 存取同事聊天

合格客戶的使用者可透過預設存取試用版中的Co-worker Chat，因此不需要採取任何動作。 「同事聊天」在使用者指導和監督下運作，並遵守您組織現有的產品層級存取控制。 使用者只能在其組織的基礎CX Enterprise產品中執行已獲准執行的動作。
...
### 透過由Agent Orchestrator提供支援的AI助理存取Experience Platform代理程式
...
- [Coworker](https://experienceleague.adobe.com/zh-hant/docs/cx-enterprise-ai/experience-cloud-ai/coworker/overview)
...
請閱讀下列內容，瞭解有關Experience Platform Agent試用版的常見問題解答。

### 什麼是Adobe Experience Platform Agents試用版？

Agentic使用規範試用版可讓合格客戶使用同事聊天（或選取Experience Platform代理程式），不需額外付費，最多可獲得10,000個AI積分。 目標是在客戶做出商業決定之前，提供低摩擦、低風險的途徑，讓客戶從這些代理獲得體驗價值。
...
本試用版不需要額外購買。 付費方案沒有自動轉換。 如果客戶決定在試用期之後繼續使用同事聊天（或Experience Platform代理），Adobe客戶團隊將與客戶合作，以轉換至付費產品。
...
試用期會在您沖銷最多10,000個AI積分的初始一次性權益或授權其他AI積分後結束。

試用期結束後，您可以選擇：

- 不要往前移
  - 試用存取權將會過期。
  - 您現有的Adobe產品會如前繼續運作，不會因為未轉換試用版而受罰
- 繼續使用「同事聊天」（或Experience Platform Agent）
  - 您可以與您的Adobe客戶團隊合作，轉換至付費方案。

沒有自動隱藏開關可用來將試用期已結束的客戶轉換為付費客戶。
